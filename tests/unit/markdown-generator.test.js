...
const baseCompany = {
  ...
  career: ["https://cariere.metro.ro"],
  lastScraped: "2026-06-17"
};

const baseJob = {
  url: "https://cariere.metro.ro/en/vacancy/123_en",
...
describe("generateJobsMarkdown", () => {
  describe("company section", () => {
    ...
    it("includes career page as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("[https://cariere.metro.ro](https://cariere.metro.ro)");
    });
  ...
  describe("jobs section", () => {
    ...
    it("includes job URL as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, [baseJob]);
      expect(md).toContain("[https://cariere.metro.ro/en/vacancy/123_en]");
    });
    ...
    it("renders multiple jobs", () => {
      const job2 = { ...baseJob, title: "DevOps Engineer", url: "https://cariere.metro.ro/en/vacancy/456_en" };
    ...
    it("handles job with no optional fields", () => {
      const minimal = { url: "https://cariere.metro.ro/en/vacancy/999_en", title: "QA Engineer" };
